package com.kenneth.boot.cloud.tencent.youtu;
...
public class YoutuCall {
	 ...
	 *            授权secret_key
	 */
	public YoutuCall(String appid, String secret_id, String secret_key,String end_point,String user_id) {
		m_appid = appid;
	 ...
	 */
	public JSONObject handWritingOcr(String image_path, String image_url) throws IOException,
	JSONException, KeyManagementException, NoSuchAlgorithmException {
		StringBuffer image_data = new StringBuffer("");
		JSONObject data = new JSONObject();
		...
		JSONObject respose =m_not_use_https?SendHttpRequest(data, "ocrapi/handwritingocr"):SendHttpsRequest(data, "ocrapi/handwritingocr");
		return respose;
	}
